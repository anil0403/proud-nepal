...
export const SizeForm: React.FC<SizeFormProps> = ({ initialData }) => {
  ...
  const title = initialData ? "Edit Processor" : "Create Processor";
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error(
        "Make sure you removed all products using this processor first."
      );
    } finally {
      setLoading(false);
      setOpen(false);
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="5600 H" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
